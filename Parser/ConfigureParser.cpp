...
Parser* ConfigParseToConsole::Build() {
  try {
    ...
    pTypedefAndAlias = new TypedefAndAlias;
    pParser->addRule(pTypedefAndAlias);
    pDeclarationScope->addAction(pPushDeclarationScope);
    pAddTypedefAndAlias = new AddTypedefAndAlias(pRepo);
    pTypedefAndAlias->addAction(pAddTypedefAndAlias);
